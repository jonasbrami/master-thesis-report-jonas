...
A velocity field is a function taking as input  a \Brett {state, $q$} \Brett{In our case, the velocity field is a path (a function of position, not a function of time) as opposed to a trajectory (function of position AND time).} and returns a 3 dimensional \Brett{desired} velocity vector $(u,v,w)$.\\
