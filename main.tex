\newlength{\bibsep}
\documentclass[nonatbib,1p,a4paper]{elsarticle}  % 5p for two columns, 1p for 1 column (this is specific for the elsearticle)
...
\input{Text/2-Background and Literature Review}
\input{Text/3-Design and Theory}
\input{Text/4-Implementation}
\input{Text/5-Results, Evaluation and Experiments}
\input{Text/6-Conclusion, Future Work}
